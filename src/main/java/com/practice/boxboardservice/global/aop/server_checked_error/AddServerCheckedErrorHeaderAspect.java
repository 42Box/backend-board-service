package com.practice.boxboardservice.global.aop.server_checked_error;
...
public class AddServerCheckedErrorHeaderAspect {
  ...
  @Around("@annotation(com.practice.boxboardservice.global.aop.server_checked_error.AddServerCheckedErrorHeader) && args(ex,..)")
