...
public class ServiceBoardsDislikesEntity extends BaseEntity implements LikesEntity {
  ...
  @Builder
  public ServiceBoardsDislikesEntity(Long boardId, String userUuid) {
